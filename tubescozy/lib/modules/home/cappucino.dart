...
double? width;
double? height;
final bodies = [cappucinoscreen(), History(), Detail()];
final TextEditingController jumlahController = TextEditingController();
final TextEditingController keteranganController = TextEditingController();

class cappucino extends StatefulWidget {
  const cappucino({Key? key}) : super(key: key);

  _cappucinoState createState() => _cappucinoState();
}
...
class cappucinos extends StatefulWidget {
  @override
  _cappucinos createState() => _cappucinos();
}

class _cappucinos extends State<cappucinos> {
  String name = "";
  String pilihan = "";
  dynamic infouser;
                                      ...
                                      children: [
                                        ...
                                        FittedBox(
                                          ...
                                          child: SizedBox(
                                            width: 150,
                                            height: 200,
                                            child: Image.asset('img/cappucino.png'),
                                          ),
                                        ),
                                        SizedBox(height: 15,),
                                        Text("Kopi Cappucino",
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text("secangkir kopi susu yang berasal dari Italia dan mulai hadir di Eropa "
                                                  "dan Amerika sejak tahun 1980-an.",
