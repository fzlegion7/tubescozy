...
double? width;
double? height;
final bodies = [kentangscreen(), History(), Detail()];
final TextEditingController jumlahController = TextEditingController();
final TextEditingController keteranganController = TextEditingController();


class kentang extends StatefulWidget {
  const kentang({Key? key}) : super(key: key);

  _kentangState createState() => _kentangState();
}
...
class kentangscreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class kentang2 extends StatefulWidget {
  @override
  _kentang2 createState() => _kentang2();
}

class _kentang2 extends State<kentang2> {
  String name = "";
  String pilihan = "";
  dynamic infouser;
                                      ...
                                      children: [
                                        ...
                                        FittedBox(
                                          ...
                                          child: SizedBox(
                                            width: 150,
                                            height: 200,
                                            child: Image.asset('img/kentang.png'),
                                          ),
                                        ),
                                        SizedBox(height: 15,),
                                        Text("Kentang",
